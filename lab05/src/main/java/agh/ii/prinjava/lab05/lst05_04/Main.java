...
public class Main {
    ...
    private static void demo2() {
        ...
        Comparator<Box2<Integer>> box2Cmp2 = (o1, o2) -> o1.getE() - o2.getE();

        // (3)
        Comparator<Box2<Integer>> box2Cmp3 = Comparator.comparingInt(Box2::getE);
        ...
        //Collections.sort(boxes, box2Cmp2);
        //Collections.sort(boxes, box2Cmp3);
        Collections.sort(boxes, box2Cmp4);
...
class Box1<T extends Comparable<T>> implements Comparable<Box1<T>> {
    private T e;
...
class Box2<T> {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false;
        Box2<?> box2 = (Box2<?>) o;
        return Objects.equals(e, box2.e);
    }
